...
6. Complete all five parts of the Getting Started with Tone.js | Web Audio Tutorial - Pts 1-5 (3:31, 6:37, 10:20, 5:59, 9:28). Post a link to your finished project online here: https://alpnix.github.io/Radical-Software-DevLogs/2-1/puzzle-tones.html
...
10. Post links to your project, a video, and a 100-150 word statement about the concept and technology of your interactive audio experience here: 
I really liked the tonematrix example from the inspiration websites. I've always liked playing puzzles so I wanted to assign each piece of a puzzle into a note for the user to have a creativity around generating a harmony the way the play the puzzle themselves. Some future steps for this could be users being able to drag and drop the puzzle pieces into the board themselves can create and replay certain harmonies. Apart from that, I want to learn more about the notes that play well with each other to be able to place them accordingly into the relevant pieces instead of just having a random set of notes appearing in the different pieces. 